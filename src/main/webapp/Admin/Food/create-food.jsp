            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="p-5">
                        ...
                        <form class="user " action="/foods/create" method="post" id="create-form">
                            <div class="form-group">
                                <label class="w3-text-blue"><b>Name</b></label>
                                <input name="name" type="text" class="form-control form-control-user" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" class="form-control form-control-user" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="thumbnail" class="form-control form-control-user" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" id="Status" aria-label="Default select Status" required>
                                    <option value="" selected>Open this select menu</option>
